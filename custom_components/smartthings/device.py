...
class Command:
    ...
    set_brightnesslevel = "setBrightnessLevel"
...
class DeviceEntity(Entity, Device):
    ...
    async def set_brightnesslevel(
        self, level: str, set_status: bool = False, *, component_id: str = "cavity-02"
    ) -> bool:
    
        """NB Call the set_brightnesslevel."""
        return await self.command(
            component_id, Capability.oven_light, Command.set_brightnesslevel,[level]
        )
